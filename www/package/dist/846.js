...
"use strict";(self.webpackChunk_gesis_web_gesis_web_frontend=self.webpackChunk_gesis_web_gesis_web_frontend||[]).push([[846],{846:(t,e,n)=>{n.d(e,{A:()=>Ge})
var a,r,o,i,l=n(692),s=function(t,e){if(s.factory(t,e))return s
...
for(r=0,s=h.length;r<s;r++)for(a=(n=h[r]).firstChild;a;){if("TD"==a.nodeName.toUpperCase()||"TH"==a.nodeName.toUpperCase())for(c=(c=1*a.getAttribute("colspan"))&&0!==c&&1!==c?c:1,d=(d=1*a.getAttribute("rowspan"))&&0!==d&&1!==d?d:1,u=p(t,r,0),f=1===c,i=0;i<c;i++)for(o=0;o<d;o++)t[r+o][u+i]={cell:a,unique:f},t[r+o].nTr=n
